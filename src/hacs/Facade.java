...
//functions for CourseMenu
    /*
     * On clicking the add button of the CourseMenu, this function gets called
     * The function will intern create new assignment, fill the required information
     * Pass the pointer of the Assignment and the person pointer to this function
     * The function will call InstructorAssignmentMenu or StudentAssignmentMenu according to
     * the type of the user it will not update the course menu.
     * The coursemenu need to refreshed outside the function
     */
...
//functions for InstructorAssignmentMenu
    /*
     * this function will grade the given Solution: theSolution function calls
     */
    ...
    /*
     * create a course-list and initialize it with file CourseInfo.txt
     */
     ...
     * create courselist, read the UserCourse.txt file, match coursename with theCouresList,
     * attach the matched course object to the new user created Facade.thePerson.CourseList
     */
     ...
     * return the selected course and then assign the course to class member
     * CourseLeve=0 High, CourseLeve=1 Low
     */
    ...
    /*
     * call the thePerson.CreateCourseMenu according object(student or instructor)
     * and for the nCourseLevel, it will call different menu creater and display the menu;
     */
    ...
    /*
     * find the course in theCourseList that matches strCourseName 1
     * create a CourseIterator for the List 2
     * Find the Course with the Iterator
     * return the pointer of the Course if not fine, return null;
     */
